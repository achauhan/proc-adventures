...
{
    55,
    "C:\\Users\\593091\\Documents\\code\\proc-adventures\\hello.pc"
};


static unsigned int sqlctx = 740605331;
...
{13,4128,1,27,0,
5,0,0,0,0,0,27,138,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,10,0,0,
36,0,0,2,41,0,4,140,0,0,1,0,0,1,0,2,97,0,0,
55,0,0,3,66,0,4,141,0,0,1,0,0,1,0,2,97,0,0,
74,0,0,4,0,0,30,147,0,0,0,0,0,1,0,
};
...

{
    ...
    sqlstm.sqhstv[2] = (         void  *)sid;
    sqlstm.sqhstl[2] = (unsigned int  )17;
    sqlstm.sqhsts[2] = (         int  )17;
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select banner into :b0  from v$version where banner like \
'Oracle%'";
    sqlstm.iters = (unsigned int  )1;
